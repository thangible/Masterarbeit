...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Meta information:
\newcommand{\trtitle}{Image Augmentation Techniques for Marine Wildlife Detection in Aerial Images}
\newcommand{\trtype}{Bachelor thesis} %{Bachelorthesis} %{Diplomarbeit} %{Dissertation}
...
\newcommand{\trgutachterA}{\href{mailto: @informatik.uni-hamburg.de}{Prof. Tayfun}}
\newcommand{\trgutachterB}{\href{mailto:@informatik.uni-hamburg.de}{Dr. ....}}
%\newcommand{\trbetreuung}{\href{mailto:tbd@informatik.uni-hamburg.de}{Dipl.-Inform. To Be Defined}}
\newcommand{\trfach}{HiTec}
\newcommand{\trdate}{30.02.2023}
